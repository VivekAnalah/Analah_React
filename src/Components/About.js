  ...
  return (
    <div className="bg-[#FAFFFF] mt-[0px] scroll-mt-[100px]" id="about" ref={targetDivRef} >
      ...
      <div className="flex space-y-5 flex-col justify-center pt-5">
        ...
        <h5 className="font-normal text-base text-justify lg:text-[14px] xl:text-[16px] 2xl:text-[18px]  text-[#595959] my-1 pt-[30px]">
        ...
        <h5 className="font-normal text-base text-justify  lg:text-[14px] xl:text-[16px] 2xl:text-[18px]  text-[#595959] my-1">
        ...
        <h5 className="font-noraml text-base text-justify  lg:text-[14px] xl:text-[16px] 2xl:text-[18px]  text-[#595959] my-1">
