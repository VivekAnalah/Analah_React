...
function About() {
  return (
    <div className="bg-[#FAFFFF] mt-[0px]" id="about" >
      ...
      <div className="flex space-y-5 flex-col justify-center pt-5">
        ...
        <h5 className="font-normal text-base text-justify lg:text-xl xl:text-[18px] text-[#595959] my-1">
        ...
        <h5 className="font-noraml text-base text-justify lg:text-xl xl:text-[18px] text-[#595959] my-1">
